#!/usr/bin/env bash
# Render the lusterpass agent-safe demo GIF.
...
echo "[record] rendering demo.tape -> agent-safe-demo.gif"
vhs demo.tape

echo "[record] done -> $(pwd)/agent-safe-demo.gif"
ls -lh agent-safe-demo.gif
